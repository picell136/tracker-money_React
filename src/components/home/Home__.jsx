    ...
    return <>
            <div>
                <div className={styles.navigation}>
                    <button className={styles["icon-arrow"]} onClick={prevDay} type="button">
                        <ChevronLeft size={24} /> 
                    </button>
                    
                    <div className={styles.date}> {displayDay} {convertMonths(displayMonth)} {displayYear} года </div>
                    
                    <button className={styles["icon-arrow"]} onClick={nextDay} type="button">
                ...
                <div className={styles.tabs} >  
                    <div className={styles["tab-btn"]}>      
                        <button className={styles["tab-categories"]}>
                            <NavLink to="/categories">Категории</NavLink>
                        </button>

                        <button className={styles["tab-stats"]}>
