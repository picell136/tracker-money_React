...
Веб-приложение для учёта повседневных трат: покупки по дням, категории, статистика за период и выгрузка в CSV. 

Сайт: [financetrack.ru](https://financetrack.ru/)

Данные хранятся в браузере (`localStorage`), отдельно для каждого пользователя.
